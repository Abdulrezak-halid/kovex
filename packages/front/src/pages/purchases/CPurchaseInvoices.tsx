...
export default function CPurchaseInvoices() {
  ...
  const columns = [
    ...
    {
      header: "Status",
      cell: (r: PurchaseInvoice) => <CStatusBadge status={r.status} />,
    },
    {
      header: "Total",
      cell: (r: PurchaseInvoice) => (
    ...
    {
      header: "Date",
      cell: (r: PurchaseInvoice) => new Date(r.createdAt).toLocaleDateString(),
    },
    {
      header: "Actions",
      cell: (r: PurchaseInvoice) => (
  ...
  return (
    <div className="p-6">
      ...
      <CDataTable
        ...
        isLoading={isLoading}
        keyField="id"
        emptyMessage="No purchase invoices."
      />
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editing ? "Edit Invoice" : "New Purchase Invoice"}
            </DialogTitle>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              onClick={handleSave}
              disabled={
                (!editing && (!supplierId || !totalAmount)) ||
